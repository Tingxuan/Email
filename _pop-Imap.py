...
# Email address
MAILADDR = 'm13618311520@163.com'  # '843384561@qq.com'#"neuromancer43@gmail.com"

# Email password
PASSWORD = 'jkl7888927'  # 'Matrix43'#"asd19981015"

# Mail Server (pop/imap)
SERVER = 'imap.163.com'  # 'pop.163.com'#'pop.qq.com'#"pop.gmail.com"
...
OUTDIR = r"C:\Users\84338\Desktop\result"
...
def imap4(host, port, usr, pwd, use_ssl):
    ...
    for folder in folders:
        ...
        try:
            folder = list(map(bin, folder.split('')))
            flags, delimiter = list_pattern.match(
                folder[0]), list_pattern.match(folder[1])
            folder_name = list_pattern.match(str(folder[2]).decode('utf-7'))
        ...
        try:
            ...
            print(
                "[*] {0} emails found in {1} ({2})".format(msg_num, usr, folder_name))
        except BaseException as e:
            print(
                "[-] Can't get email number of {0}: {1}".format(folder_name, e))
            continue
...
if __name__ == "__main__":
    ...
    result_path = os.path.join(os.path.join(OUTDIR, mailaddr))
